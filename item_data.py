...
# GEMS
item_data['gcv'] = ItemTypeData(1, 1, ItemGroup.GEM_CHIPPED)  # Chipped Amethyst
item_data['gcw'] = ItemTypeData(1, 1, ItemGroup.GEM_CHIPPED)  # Chipped Diamond
item_data['gcg'] = ItemTypeData(1, 1, ItemGroup.GEM_CHIPPED)  # Chipped Emerald
item_data['gcr'] = ItemTypeData(1, 1, ItemGroup.GEM_CHIPPED)  # Chipped Ruby
item_data['gcb'] = ItemTypeData(1, 1, ItemGroup.GEM_CHIPPED)  # Chipped Saphire
item_data['skc'] = ItemTypeData(1, 1, ItemGroup.GEM_CHIPPED)  # Chipped Skull
item_data['gcy'] = ItemTypeData(1, 1, ItemGroup.GEM_CHIPPED)  # Chipped Topaz
...
item_data['gsv'] = ItemTypeData(1, 1, ItemGroup.GEM_NORMAL)  # Amethyst
item_data['gsw'] = ItemTypeData(1, 1, ItemGroup.GEM_NORMAL)  # Diamond
item_data['gsg'] = ItemTypeData(1, 1, ItemGroup.GEM_NORMAL)  # Emerald
item_data['gsr'] = ItemTypeData(1, 1, ItemGroup.GEM_NORMAL)  # Ruby
item_data['gsb'] = ItemTypeData(1, 1, ItemGroup.GEM_NORMAL)  # Saphire
item_data['sku'] = ItemTypeData(1, 1, ItemGroup.GEM_NORMAL)  # Skull
item_data['gsy'] = ItemTypeData(1, 1, ItemGroup.GEM_NORMAL)  # Topaz
